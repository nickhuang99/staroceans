...
typedef int (SimpleXmlCallback)(const char *elementPath, const char *data,
...
typedef struct SimpleXml
{
    ...
    char elementPath[1024]; // arbitary???
...
void simplexml_initialize(SimpleXml *simpleXml, SimpleXmlCallback *callback, void *callbackData);

int simplexml_add(SimpleXml *simpleXml, const char *data, int dataLen);
