...
bool MyX264::write_file(unsigned char* pData, unsigned int size)
{
...
bool MyX264::write_nal(x264_nal_t* p_nal, int i_nal)
{
...
bool MyX264::param_apply_preset( x264_param_t *param, const char *preset)
{
...
bool MyX264::param_apply_tune( x264_param_t *param, const char *s )
{
...
bool MyX264::param_apply_profile( x264_param_t *param, const char *profile )
{
