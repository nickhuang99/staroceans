...
typedef struct img_par
{
  ...
  unsigned int dc_pred_value_comp[3];         //!< component value for DC prediction (depends on component pel bit depth)
...
int  intrapred_luma_16x16(ColorPlane pl, struct img_par *img,int predmode);
