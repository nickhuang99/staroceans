...
extern void itrans(struct img_par *img,int ioff,int joff,int i0,int j0, int chroma, int yuv);
extern void itrans_sp(struct img_par *img,int ioff,int joff,int i0,int j0);
extern int  intrapred(ColorPlane pl, struct img_par *img,int ioff,int joff,int i4,int j4);
extern void itrans_2 (ColorPlane pl, struct img_par *img);
extern void iTransform(ColorPlane pl, struct img_par *img, Macroblock *currMB, int need_4x4_transform, int smb, int yuv);
#endif
